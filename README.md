...
It is built with different ranges of frameworks. Leave the add-ons/add-ons for the acknowledgments section. Below are some examples.
...
# Git Import Rep
  ```sh
  git clone https://github.com/Freddx-web/APP-Expo-Full-Stack-Template.git
  ```
